...
namespace my
{
	...
	public:
		...
		static void shuffle(std::chrono::system_clock::time_point const & time_point, std::vector<std::string> & vector);
		static void shuffle(unsigned long long const & seed, std::vector<std::string> & vector);
